...
// WIT-SVID clauses (WIT-SVID.md). Marked Stability: Incubating upstream, so
// this block is the most likely in the table to churn.
var (
	...
	// SHOULD NOT here, where the JWT-SVID's equivalent is a MUST NOT.
	...
	WITCnfJWKPublic = Clause{"WIT-SVID.md", "§3.2", SeverityMUST,
		"cnf.jwk MUST be a public key, not private or symmetric key material"}
	...
	WITNoAud = Clause{"WIT-SVID.md", "§3.8", SeverityMUST,
		"aud claim MUST NOT be included"}
)
